...
function useSCWidget() {
  ...
  const onReady = react.useCallback(async (_ctx) => {
  ...
  const onPlayProgress = react.useCallback((e) => {
  ...
  const controls = {
    ...
    seekTo: react.useCallback((ms) => {
      var _a;
      (_a = ref.current) == null ? void 0 : _a.seekTo(ms);
    }, []),
    setVolume: react.useCallback((v) => {
      var _a;
    ...
    skip: react.useCallback((i) => {
      var _a;
      (_a = ref.current) == null ? void 0 : _a.skip(i);
    }, []),
    load: react.useCallback((url, options) => {
      var _a;
...
exports.SCWidgetEvents = SCWidgetEvents;
exports.default = SCWidget;
exports.useSCWidget = useSCWidget;
