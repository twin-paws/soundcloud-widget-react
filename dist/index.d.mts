import React, { CSSProperties, HTMLAttributeReferrerPolicy } from 'react';

declare enum SCWidgetEvents {
    READY = "ready",
    PLAY = "play",
    PAUSE = "pause",
    FINISH = "finish",
...
interface SCWidgetProps extends SCWidgetParams {
    ...
    onEvent?: {
        [K in SCWidgetEvents]?: (payload: SCWidgetEventMap[K]) => void;
    };
    title?: string;
    loading?: "eager" | "lazy";
    allow?: string;
...
declare function useSCWidget(): UseSCWidgetResult;

export { type SCAudioEventPayload, type SCSound, SCWidget, type SCWidgetEventMap, SCWidgetEvents, type SCWidgetInstance, type SCWidgetParams, type SCWidgetProps, type SCWidgetRef, type SCWidgetState, SCWidget as default, useSCWidget };
